#Aquatic Vegetation time series
#Emgerency Drought Barrier Report


#NOTE: copied this code from seasonal monitoring report but haven't updated it yet for the EDB report
