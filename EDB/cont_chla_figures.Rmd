...
# Import daily averages and medians of the continuous chlorophyll data
df_cont_chla_orig <- read_csv("EDB/cont_chla_daily_values.csv")
...
df_cont_chla_clean <- df_cont_chla_orig  %>% 
  # Don't include stations outside of the EDB regions for now, and only include Apr-Dec for 2020 and 2021
  filter(
    Region != "Outside",
    Year %in% 2020:2021,
    month(Date) %in% 4:12
