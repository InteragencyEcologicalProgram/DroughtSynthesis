...
i_am("EDB/cont_chla_figures.Rmd")
```
...
df_d_chla_orig <- read_csv(here("EDB/d_chla_fal_osj_d19.csv"))
```
...
ggsave(
  here("EDB/cont_chla_ts_daily_avg.jpg"),
  plot = plt_ts_avg,
  width = 6.5,
  height = 8.25,
  units = "in"
...
ggsave(
  here("EDB/cont_chla_ts_daily_med.jpg"),
  plot = plt_ts_med,
  width = 6.5,
  height = 8.25,
  units = "in"
...
ggsave(
  here("EDB/cont_d_chla_ts_comp.jpg"),
  plot = plt_ts_d_cont,
  width = 4.5,
  height = 5,
  units = "in"
...
ggsave(
  here("EDB/cont_chla_bp_season.jpg"),
  plot = plt_bp_seas,
  width = 6.5,
  height = 4,
  units = "in"
