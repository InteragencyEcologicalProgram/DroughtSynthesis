...
# subset dfs
df_sf <- subset(df_sf, select = c('Date', 'SubRegion', 'Station', 'Season', 'WY', 'Long_term', 'Latitude', 'Longitude', 'DissAmmonia', 'DON', 'DissNitrateNitrite', 'TotPhos', 'DissSilica', 'DS'))
df_emp <- subset(df_emp, select = c('Date', 'SubRegion', 'Station', 'Season', 'WY', 'Long_term', 'Latitude', 'Longitude', 'DissAmmonia', 'DON', 'DissNitrateNitrite', 'TotPhos', 'DissSilica', 'DS'))
```
...
ggplot(df_wq, aes(Date, DissSilica, color = DS)) +
  geom_point()
```
