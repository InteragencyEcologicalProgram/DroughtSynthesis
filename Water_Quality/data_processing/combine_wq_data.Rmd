...
# subset dfs
df_sf <- subset(df_sf, select = c('Date', 'SubRegion', 'Station', 'Season', 'WY', 'Long_term', 'Latitude', 'Longitude', 'DissAmmonia', 'DissNitrateNitrite', 'DissOrthophos', 'DissSilica', 'DS'))
df_emp <- subset(df_emp, select = c('Date', 'SubRegion', 'Station', 'Season', 'WY', 'Long_term', 'Latitude', 'Longitude', 'DissAmmonia', 'DissNitrateNitrite', 'DissOrthophos', 'DissSilica', 'DS'))
df_wsc <- subset(df_wsc, select = c('Date', 'SubRegion', 'Station', 'Season', 'WY', 'Long_term', 'Latitude', 'Longitude', 'DissAmmonia', 'DissNitrateNitrite', 'DissOrthophos', 'DS'))
```

```{r}
# combine
df_wq <- bind_rows(df_emp, df_sf, df_wsc)
