...
write_aov(df_aov, filepath = here("Water_Quality/nutr_aov_di.csv"))
...
ggsave(
  filename = here("Water_Quality/bp_em_DissAmmonia_di_sea.jpg"), 
  plot = plt_am_seas, 
  width = 7, 
  height = 4.5,
  units = "in"
...
write_aov(df_aov, filepath = here("Water_Quality/nutr_aov_di.csv"), space = TRUE, append = TRUE)
...
plt_am_reg
ggsave(
  filename = here("Water_Quality/bp_em_DissAmmonia_di_reg.jpg"), 
  plot = plt_am_reg, 
  width = 7, 
  height = 4.5,
  units = "in"
...
ggsave(
  filename = here("Water_Quality/bp_em_DissNitrateNitrite_di_sea.jpg"), 
  plot = plt_nn_seas, 
  width = 7, 
  height = 4.5,
  units = "in"
...
ggsave(
  filename = here("Water_Quality/bp_em_DissNitrateNitrite_di_reg.jpg"), 
  plot = plt_nn_reg, 
  width = 7, 
  height = 4.5,
  units = "in"
...
ggsave(
  filename = here("Water_Quality/bp_em_DissOrthophos_di_sea.jpg"), 
  plot = plt_op_seas, 
  width = 7, 
  height = 4.5,
  units = "in"
...
plt_op_reg
ggsave(
  filename = here("Water_Quality/bp_em_DissOrthophos_di_reg.jpg"), 
  plot = plt_op_reg, 
  width = 7, 
  height = 4.5,
  units = "in"
