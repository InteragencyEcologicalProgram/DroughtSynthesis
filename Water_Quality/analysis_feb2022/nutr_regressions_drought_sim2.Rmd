...
write_aov(df_aov, filepath = here("Water_Quality/nutr_aov_di_sim2_extra.csv"))
...
write_aov(df_aov, filepath = here("Water_Quality/nutr_aov_di_sim2_extra.csv"), space = TRUE, append = TRUE)
