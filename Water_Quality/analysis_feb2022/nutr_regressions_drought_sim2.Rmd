...
write_aov(df_aov, filepath = 'Water_Quality/results/extra_sims/aov_di_sim2.csv')
...
write_aov(df_aov, filepath = 'Water_Quality/results/extra_sims/aov_di_sim2.csv', space = TRUE, append = TRUE)
