...
emm_seas_WY <- emmeans(lm_seasonal, specs = pairwise ~ Drought:Drought, adjust = 'Tukey')
...
lm_seasonal <- lm(DissNitrateNitrite ~ Drought + Region + DissNN_onelag, data = df_nn_regional)
...
emm_reg_WY <- emmeans(lm_regional, specs = pairwise ~ Drought:Drought, adjust = 'Tukey')
...
lm_seasonal <- lm(DissAmmonia ~ Drought + Region + DissAM_onelag, data = df_am_regional)
