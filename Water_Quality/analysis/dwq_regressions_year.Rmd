...
# save plots
# dissam
bp_em_DissAmmonia_yt_both <- dual_year_plts(plt_am_reg, plt_am_seas)
ggsave(paste0(getwd(),'/Water_Quality/plots/bp_em_DissAmmonia_yt_both.jpg'), bp_em_DissAmmonia_yt_both, width = 8, height = 3.5)

# dissnn
bp_em_DissNitrateNitrite_yt_both <- dual_year_plts(plt_nn_reg, plt_nn_seas)
...
# dissorthophos
bp_em_DissOrthophos_yt_both <- dual_year_plts(plt_op_reg, plt_op_seas)
