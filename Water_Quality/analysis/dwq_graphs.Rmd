...
#  ggsave(paste0(getwd(),'/Water_Quality/plots/bp_',analyte,'_yt.jpg'),plt_bp, width = 7, height = 4.5)
}
...
for (analyte in c('DissAmmonia','DissOrthophos','DissNitrateNitrite')){
  ...
  ggsave(paste0(getwd(),'/Water_Quality/plots/bp_',analyte,'_di.jpg'),plt_bp, width = 7, height = 4.5)
}
```
