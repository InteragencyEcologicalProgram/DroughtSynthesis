...
# ggsave(paste0(getwd(),'/Water_Quality/plots/bp_em_DissAmmonia_di_sea.jpg'), plt_am_lt_di, width = 7, height = 4.5)
```
...
# ggsave(paste0(getwd(),'/Water_Quality/plots/bp_em_DissAmmonia_reg_reg.jpg'), plt_op_reg_reg, width = 4.5, height = 3)
```
